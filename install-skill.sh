...
set_skill_dirs_for_target() {
  ...
  case "$target" in
    claude)
      SKILL_DIRS=(codex__colon__rescue codex__colon__status codex__colon__result codex__colon__cancel delegate__colon__setup)
      ;;
    codex)
      SKILL_DIRS=(claude__colon__rescue claude__colon__status claude__colon__result claude__colon__cancel delegate__colon__setup)
      ;;
    *)
