...
Use this when an orchestrator should delegate a read-only code review to the claude backend through delegate's sanitized review-context pipeline and return immediately with the launch envelope.
